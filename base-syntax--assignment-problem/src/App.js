...
const App = () => {
  const [userDetailsState, setUserDetailsState] = useState({
    users: [
      { username: "Jaco Zwarts", password: "123456" },
      { username: "Isabella Zwarts", password: "54321" },
    ]
  });
  const onUserNameChanged = (event) => {
    setUserDetailsState({users: [
      { username: event.target.value, password: "123456" },
      { username: "Isabella Zwarts", password: "54321" },
    ]});
  }
  return (
    <div className="App">
      ...
      <UserInput  changed={onUserNameChanged} username={userDetailsState.users[0].username}/>
      <UserOutput username={userDetailsState.users[0].username} password={userDetailsState.users[0].password} />
      <UserOutput username={userDetailsState.users[1].username} password={userDetailsState.users[1].password}/>
    </div>
  );
};
